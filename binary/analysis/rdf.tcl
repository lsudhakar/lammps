...
set rdfAA [measure gofr $sel1 $sel2 delta 0.1 rmax 15 usepbc 1 selupdate 1 first 1 last -1 step 1];

set sel1 [atomselect top "type B"]
set sel2 [atomselect top "type B"]
set rdfBB [measure gofr $sel1 $sel2 delta 0.1 rmax 15 usepbc 1 selupdate 1 first 1 last -1 step 1];

set sel1 [atomselect top "type A"]
set sel2 [atomselect top "type B"]
set rdfAB [measure gofr $sel1 $sel2 delta 0.1 rmax 15 usepbc 1 selupdate 1 first 1 last -1 step 1];
...
foreach j $r k $gr l $igr kAA $grAA lAA $igrAA kBB $grBB lBB $igrBB kAB $grAB lAB $igrAB {
   puts $fp "$j $k $l $kAA $lAA $kBB $lBB $kAB $lAB"
}
close $fp
